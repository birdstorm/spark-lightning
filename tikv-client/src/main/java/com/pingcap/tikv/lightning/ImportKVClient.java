...
public class ImportKVClient extends AbstractGRPCClient<ImportKVBlockingStub, ImportKVStub> {
  ...
  public void openEngine(byte[] uuid) {
    ...
    callWithRetry(
        ...
        ImportKVGrpc.getOpenEngineMethod(),
        request,
        noopHandler);
  }
  ...
  public void closeEngine(byte[] uuid) {
    ...
    callWithRetry(
        ConcreteBackOffer.newCustomBackOff(1),
        ImportKVGrpc.getCloseEngineMethod(),
        request,
        noopHandler);
  }
  ...
  public void cleanupEngine(byte[] uuid) {
    ...
    callWithRetry(
        ConcreteBackOffer.newCustomBackOff(1),
        ImportKVGrpc.getCleanupEngineMethod(),
        request,
        noopHandler);
  }
  ...
  public void writeRowsV3(
    ...
    callWithRetry(
        ConcreteBackOffer.newCustomBackOff(1),
        ImportKVGrpc.getWriteEngineV3Method(),
        request,
        noopHandler);
  }
  ...
  public void importEngine(byte[] uuid) {
    ...
    callWithRetry(
        ConcreteBackOffer.newCustomBackOff(1),
        ImportKVGrpc.getImportEngineMethod(),
        request,
        noopHandler);
  }
