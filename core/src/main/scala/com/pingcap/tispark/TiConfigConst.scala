...
object TiConfigConst {
  ...
  val TILIGHTNING_WRITE_ALLOW_SPARK_SQL: String = "spark.tispark.lightning.write_allow_spark_sql"
  val TILIGHTNING_IMPORTER_ADDRS: String = "spark.tispark.lightning.importer_addrs"
